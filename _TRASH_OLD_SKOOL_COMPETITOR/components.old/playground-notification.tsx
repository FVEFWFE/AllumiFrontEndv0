  ...
  return (
    <div className="pointer-events-none fixed inset-0 z-[999] flex items-start justify-end p-4">
      ...
      >
        ...
        <span className="text-base text-white font-medium">Site Setup</span>
      </button>
      {/* Modal */}
      <div
        className={cn(
              ...
              <div className="space-y-3 p-4">
                {envResults.map((env, index) => (
                  ...
                  >
                    ...
                    >
                      {env.isValid ? <Check className="h-4 w-4" /> : <AlertTriangle className="h-4 w-4" />}
                    </div>
                    <div className="min-w-0 flex-1">
                      <div className="text-sm font-medium text-[--text-primary] dark:text-[--dark-text-primary]">
                        {env.label}
                      </div>
                      <div className="truncate font-mono text-xs text-[--text-tertiary] dark:text-[--dark-text-tertiary]">
                        {env.name}
                      </div>
                    </div>
                    <div
