...
export const metadata = {
  title: "Allumi: Attribution for Skool Communities",
  description: "Track what drives members who pay and stay. See which content, ads, and sources bring high-quality, low-churn members to your Skool community.",
  icons: {
    icon: "/favicon.png",
