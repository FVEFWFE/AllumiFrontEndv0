    ...
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="max-w-4xl w-[90vw] h-[80vh] p-0">
        <DialogHeader className="p-6 pb-0">
          <DialogTitle className="text-2xl font-bold">See What Skool Hides From You</DialogTitle>
        ...
        <div className="flex-1 p-6 pt-4">
          <div className="relative w-full h-full bg-gradient-to-br from-purple-50 to-blue-50 dark:from-purple-900/20 dark:to-blue-900/20 rounded-lg border-2 border-dashed border-purple-200 dark:border-purple-700 flex flex-col items-center justify-center">
            <div className="text-center space-y-4">
              ...
              <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200">Demo Video Coming Soon</h3>
        ...
        <div className="p-6 pt-0 flex justify-center">
          <Button onClick={() => setIsOpen(false)} className="bg-purple-600 hover:bg-purple-700 text-white px-8">
