...
// Email capture component for Hero
function EmailCaptureForm() {
  ...
  if (isSubmitted) {
    return (
      <div className="w-full max-w-[80vw] md:!max-w-[500px]">
        <div className="bg-green-50 dark:bg-green-950/20 border border-green-200 dark:border-green-900 rounded-lg p-6 text-center">
          ...
          <p className="text-muted-foreground mb-2">
            We've added you to the <strong>Open Beta Waitlist</strong>
          </p>
          <p className="text-sm text-muted-foreground">
            You'll be among the first to get access when we launch. Check your email for confirmation.
          </p>
        </div>
      </div>
    )
  ...
  return (
    <form onSubmit={handleSubmit} className="w-full max-w-[80vw] md:!max-w-[500px] space-y-4">
      ...
      <p className="text-center text-xs text-muted-foreground">
        Join the beta • No credit card required • Be first to get attribution tracking
      </p>
    </form>
  )
}

// EXACT same data from original landing page
const heroData = {
  ...
  customContent: true, // Use custom email form instead of buttons
}

const companiesData = {
  subtitle: "Trusted by community owners who chose ownership over renting",
  companies: [
    { _title: "Creator Academy", url: "#", image: { url: "https://via.placeholder.com/150x50/10B981/FFFFFF?text=Creator+Academy" } },
    { _title: "Build Empire", url: "#", image: { url: "https://via.placeholder.com/150x50/10B981/FFFFFF?text=Build+Empire" } },
    { _title: "Domain Masters", url: "#", image: { url: "https://via.placeholder.com/150x50/10B981/FFFFFF?text=Domain+Masters" } },
    { _title: "Own Platform", url: "#", image: { url: "https://via.placeholder.com/150x50/10B981/FFFFFF?text=Own+Platform" } },
    { _title: "Attribution Pro", url: "#", image: { url: "https://via.placeholder.com/150x50/10B981/FFFFFF?text=Attribution+Pro" } },
  ],
}
...
const featuresData = {
  ...
  featuresGridList: {
    items: [
      {
        _id: "attribution",
        _title: "Attribution Dashboard™ (Our Secret Weapon)",
        description:
          "See exactly which content, ads, and sources drive paying members. Track lifetime value by channel. Know your CAC and ROAS. Skool shows total revenue - we show what created it.",
...
const contextSection = {
  ...
  heading: {
    ...
    subtitle: "As AI commoditizes content, knowing what converts becomes everything",
    align: "center" as const,
  },
  points: [
    {
      title: "Stop Guessing",
      description:
        "Most creators burn 70% of ad spend on channels that don't convert. Attribution shows you exactly what to cut.",
    },
    {
      title: "Scale What Works",
      description: "When you know your YouTube video drives 3x more LTV than Instagram, you double down on what works.",
    },
    {
      title: "Build Defensible Growth",
      description:
        "While competitors guess, you have data. In a world where AI can replicate content, data-driven decisions are your moat.",
    },
  ],
}
