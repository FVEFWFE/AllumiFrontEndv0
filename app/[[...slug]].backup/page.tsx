...
import { faqFragment } from "../_sections/faq"
...
import { settingsLogoLiteFragment, type SettingsLogoLiteFragment } from "../../components/form-components"
...
export const generateMetadata = async ({
  ...
  return {
    ...
    description: page.metadataOverrides.description ?? data.site.settings.metadata.defaultDescription,
  }
}
...
export default async function DynamicPage({
  ...
  const pathname = slugs ? `/${slugs.join("/")}` : "/"
  const excludedPaths = ["/community", "/members", "/dashboard", "/admin"]
